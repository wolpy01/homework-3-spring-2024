...
- В данном случае проверка открытия будет осуществляться по проверке возможности редактирования опроса, а не по превью, т.к. в данном тесте тестируется именно возможность создания новой сущности — опроса — и осуществляется проверка данных именно в ней. Тестирование превью — иной тест уже для другого случая.
