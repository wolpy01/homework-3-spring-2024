...
- Данные для тестирования:
  - **Текст вопроса**: Какая из форм расчётной сетки обладает наименьшей численной диффузией?;
...
- Далее, создаём ещё один вопрос, нажав кнопку "Добавить вопрос" и вводим следующие данные:
  - **Текст вопроса**: Какие из моделей многофазности менее требовательны к вычислительным ресурсам?;
...
- Переходим к пункту "Результат", оставляем его без изменения, т.к. поля автоматически заполнены и нажимаем кнопку "Запустить опрос".
...
- В данном случае проверка открытия будет осуществляться по проверке наличия модального окна и надписи "Редактирование опроса".
