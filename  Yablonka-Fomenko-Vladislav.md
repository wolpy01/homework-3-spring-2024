...
- Вводим необходимые поля формы:
  ...
  - Заголовок опроса (**любой текст**);
  - Описание опроса (**любой текст**).

![Заполненная форма создания опроса](./img/completed_appearance.png)

- Переходим к пункту "Вопросы", в котором заполняем необходимые вопросы и ответы на них, вводим необходимые данные.
