...
- В данном случае проверка открытия будет осуществляться по проверке возможности редактирования опроса, а не по превью, т.к. на превью присутсвуют те же данные, что и при редактировании вопроса, а также при редактировании вопроса справаа присутсвует встроенное превью, поэтому проверим лишь то, что данные сохранились и не отличаются от того, что было введено ранее.
